...
export default function Section({ id, title, subtitle, content, isActive, showButton, buttonText }: SectionProps) {
  ...
  return (
    <section id={id} className="relative h-screen w-full snap-start flex flex-col justify-center px-6 py-10 md:p-16 lg:p-24 overflow-hidden">
      ...
      <motion.h2
        className="text-3xl sm:text-4xl md:text-6xl lg:text-[5rem] xl:text-[6rem] font-bold leading-[1.1] tracking-tight max-w-4xl text-white"
      ...
      {content && (
        <motion.p
          className="text-base md:text-xl lg:text-2xl max-w-2xl mt-4 md:mt-6"
